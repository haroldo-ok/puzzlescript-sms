...
let exportSmsRomClickLink = document.getElementById("exportSmsRomClickLink");
exportSmsRomClickLink.addEventListener("click", function() {
    compile("restart");
    exportToSmsRom();
}, false);

let exportPsRomClickLink = document.getElementById("exportPsRomClickLink");
exportPsRomClickLink.addEventListener("click", function() {
    compile("restart");
    exportToPsRom();
}, false);
